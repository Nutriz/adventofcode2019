...
fun run(program: List<Int>, input: Int) : Int {
    ...
    loop@while (true) {
        ...
        val fullInstruction = memory[instrPtr].toString().padStart(5, '0')
        val opcode = fullInstruction.takeLast(2)
        val memMode1Param = fullInstruction[2]
        val memMode2Param = fullInstruction[1]
        val memMode3Param = fullInstruction[0]
